...
<table class="table table-bordered table-condensed table-hover">
	...
	<tbody>
		<tr>
			...
			<td>A fast shutdown sequence is used that doesn't free each allocated block.</td>
		</tr>
		<tr>
			...
			<td>Cache will be checked for whether a file has already been cached when file_exists(), is_file() and is_readable() are called.</td>
		</tr>
		<tr>
